<template>
  <basic-container>
    ...
    >
      ...
      <a-descriptions-item label="手机号码">{{ userInfo.phone }}</a-descriptions-item>
    ...
    >
      <a-form :model="updatePasswordForm" label-col="{ span: 6 }" wrapper-col="{ span: 14 }">
        <a-form-item label="旧密码" required>
          <a-input-password v-model="updatePasswordForm.oldPassword" placeholder="请输入旧密码" />
        </a-form-item>
        <a-form-item label="新密码" required>
          <a-input-password v-model="updatePasswordForm.newPassword" placeholder="请输入新密码" />
        </a-form-item>
        <a-form-item label="确认密码" required>
          <a-input-password v-model="updatePasswordForm.confirmPassword" placeholder="请再次输入新密码" />
        </a-form-item>
      </a-form>
    </a-modal>
  </basic-container>
